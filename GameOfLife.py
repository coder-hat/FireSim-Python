# 2017-10-21 
# Code originally from website "ActiveState Code >> Recipes"
# "Game of Life - Python 3.4 & tkinter (Python recipe)"
# http://code.activestate.com/recipes/578928-game-of-life-python-34-tkinter/
# This version copied from:
# https://raw.githubusercontent.com/ActiveState/code/3b27230f418b714bc9a0f897cb8ea189c3515e99/recipes/Python/578928_Game_of_Life__Python_34__tkinter/recipe-578928.py
#
# Author's readme file text:
#
...
# ...... ...... ...... ......
# and name it empty_board.gol (I have tested this program withwith 55x55)
# It is functional and not object oriented.
# My game of life algorithm is probably not the best one around (suggestions welcome),
# but I think this program is a nice demo of with tkinter can do and how easy it is
# to program GUI's with tkinter.
# It has been written and tested in python 3.4 but I guess any version 3 should work,
# and probably only minor changes are needed to make it work in 2.6 or 2.7 (e.g. change tkinter to Tkinter).
